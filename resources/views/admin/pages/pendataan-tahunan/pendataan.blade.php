        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Pengisian {{$pendataan->judul}}</h3>
                    <p class="text-subtitle text-muted">Isi form dibawah ini untuk mengisi pendataan</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('admin.submit-pendataan.store') }}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <!-- hidden -->
                                            <input type="hidden" name="pendataan_id" value="{{ $pendataan->id }}">
                                            <div class="col-6">
                                            <div class="form-group">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" value="{{ $pendataan->keperluan }}" class="form-control" name="keperluan" placeholder="Status/Keperluan di Tiongkok">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
